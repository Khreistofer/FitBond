  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: "1.25rem 1.5rem", borderTop: "1px solid rgba(255,255,255,.08)", display: "flex", alignItems: "center", gap: 10 }}>
        <Av initials={CURRENT_USER.avatar} size={36} bg={C.brand} />
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#fff", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{CURRENT_USER.name}</div>
          <div style={{ fontSize: 11, color: "rgba(255,255,255,.35)" }}>{CURRENT_USER.fitnessLevel}</div>
        </div>
