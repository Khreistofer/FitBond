...
export const Signup = ({ onSignupSuccess, onGoToLogin }) => {
  ...
  const submit = async e => {
    ...
    try {
      ...
      //             height, weight, age, sex, fitnessLevel,
      //             goal, sportPreferences: string[] }
      ...
      const res = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({
          ...
          sex:form.sex, fitnessLevel:form.fitnessLevel,
          goal:form.goal, sportPreferences:form.sports,
        }),
      });
      if (!res.ok) {
        const d = await res.json().catch(()=>({}));
...
//
//   GET  /api/auth/google/redirect   (Spring Security OAuth2)
//   GET  /api/auth/strava/redirect   (Spring Security OAuth2)